...
func (a *App) handleShowCustomizeTabDialog() {
	...
	a.dialog.SetCheckbox("Allow edits", a.config.UI.LastAllowEdits)
	a.dialog.SetCheckbox2("Sandbox", a.config.UI.LastIsolated)
	a.dialog.SetCheckbox3("Skip permissions", a.config.UI.LastSkipPermissions)
	a.dialog.SetSize(a.width, a.height)
	a.dialog.SetShowKeymapHints(a.config.UI.ShowKeymapHints)
	a.dialog.Show()
}
